    ...
    <div className="max-w-6xl">
      <section className="bg-white rounded-[2rem] border border-slate-100 p-10 md:p-16 shadow-sm">
        <div className="max-w-2xl text-left">
          ...
          <h1 className="font-syne text-5xl md:text-7xl font-extrabold text-[#1A1A2E] tracking-tighter leading-[1.05] mb-8">
            Nieuwe <br />
            <span className="text-[#4FC3F7]">Gezondheidscheck</span>
          </h1>

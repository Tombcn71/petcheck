    ...
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          ...
          "data-[side=left]:inset-y-0 data-[side=left]:left-0 data-[side=left]:h-full data-[side=left]:w-64 data-[side=left]:border-r",
          "data-[side=right]:inset-y-0 data-[side=right]:right-0 data-[side=right]:h-full data-[side=right]:w-64 data-[side=right]:border-l",
          "data-[side=top]:inset-x-0 data-[side=top]:top-0 data-[side=top]:h-auto data-[side=top]:border-b",
          "data-[side=left]:sm:max-w-64 data-[side=right]:sm:max-w-64",
        ...
        {...props}>
        {/* FIX VOOR CONSOLE ERROR: Verborgen titel */}
        <VisuallyHidden.Root>
          <SheetPrimitive.Title>Menu</SheetPrimitive.Title>
          <SheetPrimitive.Description>
            Navigatiemenu voor mobiel
          </SheetPrimitive.Description>
        </VisuallyHidden.Root>

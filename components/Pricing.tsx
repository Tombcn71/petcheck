  ...
  return (
    <div className="w-full bg-[#F8FAFC] py-24 font-sans">
      <div className="max-w-5xl mx-auto px-4">
        <h2 className="text-center text-4xl font-black uppercase tracking-tighter mb-4 text-slate-800 font-syne">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-stretch max-w-4xl mx-auto">
          ...
          <div className="bg-white rounded-[3rem] p-10 border border-slate-200 flex flex-col shadow-sm">
            ...
            <Link
              href="/sign-up"
              className="w-full py-5 rounded-3xl border-2 border-slate-100 text-center font-bold text-slate-400 hover:bg-slate-50 hover:border-slate-200 transition-all text-sm uppercase tracking-widest">
              Probeer Gratis
            </Link>
          </div>
          ...
          <div className="bg-white rounded-[3rem] p-10 border-2 border-[#4FC3F7] shadow-xl shadow-blue-100 flex flex-col relative scale-[1.03]">
            <div className="absolute -top-3 left-1/2 -translate-x-1/2 bg-[#4FC3F7] text-white text-[10px] font-black px-5 py-1.5 rounded-full uppercase tracking-widest">
              Aanbevolen
            </div>
